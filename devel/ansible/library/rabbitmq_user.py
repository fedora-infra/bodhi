...
class RabbitMqUser(object):
    ...
    def _exec(self, args, run_in_check_mode=False):
        if not self.module.check_mode or run_in_check_mode:
            # The following line was modified to use -s instead of -q to support the
            # version of RabbitMQ released in Fedora 30.
            # See https://github.com/ansible/ansible/pull/50381
            cmd = [self._rabbitmqctl, '-s']
            if self.node:
