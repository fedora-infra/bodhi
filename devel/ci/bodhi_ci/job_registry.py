...
def build_jobs_list(
    main_job_names: typing.Sequence[str], releases: typing.Sequence[str], options: dict
    ...
    for job_name in main_job_names:
        for release in releases:
            ...
            if release == "f42" and job_name == "unit":
                main_jobs.append((UnitOldJob, {"release": release}))
            elif release == "f42" and job_name == "docs":
                main_jobs.append((DocsOldJob, {"release": release}))
            else:
                main_jobs.append((AVAILABLE_JOBS[job_name], {"release": release}))
