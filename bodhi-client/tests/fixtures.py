        ...
        "comment": Munch(
            {
                            ...
                            Munch(
                                {
                                    ...
                                    "parent": False,
                                    "title": (
                                        "Review Request: nodejs-grunt-wrap - A Grunt plugin for "
                ...
                "karma": 0,
                "text": "i found $10000",
                "update_title": "nodejs-grunt-wrap-0.3.0-2.fc25",
                "id": 562626,
                "user": Munch(
                    {
                        "openid": "bowlofeggs.id.fedoraproject.org",
        ...
        "compose": Munch(
            {
                ...
                "request": "stable",
                "state": "requested",
                "state_date": "2018-03-15 17:25:22",
                "checkpoints": "{}",
                "release": Munch(
                    {
                        "dist_tag": "epel7",
                ...
                "date_created": "2018-03-15 17:25:22",
                "security": True,
            }
        )
    }
            ...
            Munch(
                {
                    ...
                    "update_summary": [
                        Munch(
                            {"alias": "FEDORA-EPEL-2018-50566f0a39", "title": "uwsgi-2.0.16-1.el7"}
                        ),
                        Munch(
                            {"alias": "FEDORA-EPEL-2018-328e2b8c27", "title": "qtpass-1.2.1-3.el7"}
                        ),
                    ],
                    "error_message": None,
                    "request": "stable",
            ...
            Munch(
                {
                    ...
                    "update_summary": [
                        Munch(
                            {
                                "alias": "FEDORA-EPEL-2018-32f78e466c",
...
EXAMPLE_OVERRIDE_MUNCH = Munch(
    {
        "build_id": 108570,
        "submission_date": "2017-02-28 23:05:32",
        "caveats": [],
...
EXAMPLE_EXPIRED_OVERRIDE_MUNCH = Munch(
    {
        ...
        "submitter_id": 2897,
        "build": Munch({"epoch": 0, "nvr": "js-tag-it-2.0-1.fc25", "signed": True}),
        "expired_date": "2017-03-07 23:05:31",
        "submitter": Munch(
            {
                "openid": None,
                "name": "bowlofeggs",
                ...
                "bugs": [
                    {
                        ...
                        "security": False,
                        "title": (
                            "Review Request: nodejs-grunt-wrap - A Grunt plugin for wrapping "
                            "project text files"
                        ),
                    }
                ],
                "builds": [{"epoch": 0, "nvr": "nodejs-grunt-wrap-0.3.0-2.fc25", "signed": True}],
                "close_bugs": True,
                "comments": [
                    {
                        "bug_feedback": [],
...
EXAMPLE_QUERY_OVERRIDES_MUNCH = Munch(
    {
        ...
        "overrides": [
            {
                "build": {"epoch": 0, "nvr": "nodejs-grunt-wrap-0.3.0-2.fc25", "signed": True},
                "build_id": 108565,
            ...
            {
                "build": {"epoch": 0, "nvr": "python-pyramid-1.5.6-3.el7", "signed": True},
                "build_id": 107673,
            ...
            {
                "build": {"epoch": 0, "nvr": "erlang-esip-1.0.8-1.fc25", "signed": True},
                "build_id": 98946,
            ...
            {
                "build": {"epoch": 0, "nvr": "erlang-stun-1.0.7-1.fc25", "signed": True},
                "build_id": 98945,
            ...
            {
                "build": {"epoch": 0, "nvr": "erlang-iconv-1.0.2-1.fc25", "signed": True},
                "build_id": 98942,
                "expiration_date": "2016-11-12 00:00:00",
            ...
            {
                "build": {"epoch": 0, "nvr": "erlang-stringprep-1.0.6-1.fc25", "signed": True},
                "build_id": 98941,
                "expiration_date": "2016-11-12 00:00:00",
            ...
            {
                "build": {"epoch": 0, "nvr": "erlang-fast_tls-1.0.7-1.fc25", "signed": True},
                "build_id": 98940,
                "expiration_date": "2016-11-12 00:00:00",
            ...
            {
                "build": {"epoch": 0, "nvr": "erlang-fast_yaml-1.0.6-1.fc25", "signed": True},
                "build_id": 98939,
                "expiration_date": "2016-11-12 00:00:00",
            ...
            {
                "build": {"epoch": 0, "nvr": "erlang-fast_xml-1.1.15-1.fc25", "signed": True},
                "build_id": 98938,
...
EXAMPLE_UPDATE_MUNCH = Munch(
    {
        "date_testing": "2016-10-06 00:55:15",
        "pushed": True,
            ...
            Munch(
                {
                    "bug_feedback": [],
                    "user_id": 91,
                    "timestamp": "2016-10-05 18:10:27",
                    "testcase_feedback": [],
                    "karma_critpath": 0,
                    "update_id": 69704,
                    "karma": 0,
                    "text": (
                        "This update has obsoleted [bodhi-2.2.3-1.el7]"
        ...
        "updateid": "FEDORA-EPEL-2016-3081a94111",
        "type": "bugfix",
        "close_bugs": True,
        "meets_testing_requirements": True,
        "date_submitted": "2016-10-05 18:10:22",
        "unstable_karma": -3,
        "submitter": "bowlofeggs",
        "user": Munch(
            {
        ...
        "test_cases": [],
        "notes": (
            "Update to 2.2.4. Release notes available at "
            "https://github.com/fedora-infra/bodhi/releases/tag/2.2.4\n"
        ),
        "request": None,
        "bugs": [],
        "alias": "FEDORA-EPEL-2016-3081a94111",
        "status": "stable",
        "karma": 0,
        "release": Munch(
            {
                            ...
                            "user": Munch(
                                {
                                    ...
                                    "id": 91,
                                    "avatar": (
                                        "https://apps.fedoraproject.org/img/icons/bodhi-24.png"
                                    ),
                                    "groups": [],
                                    "email": None,
                                }
                    ...
                    Munch(
                        {
                            ...
                            "text": (
                                ...
                                "FEDORA-EPEL-2016-a0eb4cc41f), and has inherited its bugs "
                                "and notes."
                            ),
                            "id": 501427,
                            "user": Munch(
...
EXAMPLE_RELEASE_MUNCH = Munch(
    {
        ...
        "released_on": None,
        "eol": None,
        "critpath_mandatory_days_in_testing": 0,
        "mandatory_days_in_testing": 0,
        "critpath_min_karma": 0,
        "min_karma": 0,
        "setting_status": None,
    }
)
...
EXAMPLE_ARCHIVED_RELEASE_MUNCH = Munch(
    {
        ...
        "released_on": None,
        "eol": None,
        "critpath_mandatory_days_in_testing": 14,
        "mandatory_days_in_testing": 7,
        "critpath_min_karma": 2,
        "min_karma": 1,
        "setting_status": None,
    }
)
...
EXAMPLE_PENDING_RELEASE_MUNCH = Munch(
    {
        ...
        "released_on": None,
        "eol": None,
        "critpath_mandatory_days_in_testing": 3,
        "mandatory_days_in_testing": 3,
        "critpath_min_karma": 2,
        "min_karma": 1,
        "setting_status": "prebeta",
    }
)
