...
def _warn_staging_overrides(
    ...
    This ensures that the user is aware that --staging supersedes --url/--id-provider.
...
def handle_errors(method: typing.Callable) -> typing.Callable:
    """
    Echo neat error messages on BodhiClientException.
    ...
    def wrapper(*args, **kwargs):
        ...
        BodhiClientExceptions will cause an exit code of 2.
        Args:
...
@url_option
@debug_option
def new(url: str, id_provider: str, client_id: str, debug: bool, **kwargs):
...
@debug_option
@handle_errors
def edit(url: str, id_provider: str, client_id: str, debug: bool, **kwargs):
    # User Docs that show in the --help
    """
...
@debug_option
@handle_errors
def request(update: str, state: str, url: str, id_provider: str, client_id: str, **kwargs):
    # User Docs that show in the --help
    """
...
@debug_option
@handle_errors
def download(url: str, id_provider: str, client_id: str, **kwargs):
    # User Docs that show in the --help
...
@debug_option
@handle_errors
def trigger_tests(update: str, url: str, id_provider: str, client_id: str, **kwargs):
    # User Docs that show in the --help
    """
