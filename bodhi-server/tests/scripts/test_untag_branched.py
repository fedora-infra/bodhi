...
class TestMain(BasePyTestCase):
    ...
    def test_exception_handler(
        self, exit, setup_logging, getLogger, initialize_db, get_appsettings, get_session
    ):
    ...
    @patch("bodhi.server.scripts.untag_branched.logging.getLogger")
    @patch("bodhi.server.scripts.untag_branched.setup_logging")
    def test_no_tags_to_remove(
        self, setup_logging, getLogger, initialize_db, get_appsettings, get_session
    ):
    ...
    @patch("bodhi.server.scripts.untag_branched.logging.getLogger")
    @patch("bodhi.server.scripts.untag_branched.setup_logging")
    def test_pending_signing_tag_present(
        self, setup_logging, getLogger, initialize_db, get_appsettings, get_session
    ):
    ...
    @patch("bodhi.server.scripts.untag_branched.logging.getLogger")
    @patch("bodhi.server.scripts.untag_branched.setup_logging")
    def test_pending_testing_tag_present(
        self, setup_logging, getLogger, initialize_db, get_appsettings, get_session
    ):
    ...
    def test_testing_tag_present(
        ...
        assert log.info.mock_calls == [
            call(release.name),
            call("Removing f17-updates-testing from bodhi-2.0-1.fc17"),
        ]
        koji.listTags.assert_called_once_with("bodhi-2.0-1.fc17")
    ...
    @patch("bodhi.server.scripts.untag_branched.logging.getLogger")
    @patch("bodhi.server.scripts.untag_branched.setup_logging")
    def test_testing_tag_present_update_too_new(
        self, setup_logging, getLogger, initialize_db, get_appsettings, get_session
    ):
