...
class TestMain(BaseTaskTestCase):
    ...
    def test_side_tag_composed_by_bodhi(self):
        ...
        handle_srtags_main(
            builds, u.release.pending_signing_tag, from_tag, None, u.release.candidate_tag
        )
    ...
    def test_side_tag_not_composed_by_bodhi(self):
        ...
        builds = [b.nvr for b in u.builds]
        handle_srtags_main(
            builds, side_tag_signing_pending, from_tag, side_tag_testing_pending, None
        )
    ...
    def test_side_tag_raise_exception(self, caplog):
        ...
        handle_srtags_main(
            builds, update.release.pending_signing_tag, None, None, update.release.candidate_tag
        )
