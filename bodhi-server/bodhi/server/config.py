    ...
    if isinstance(value, str):
        ...
        for v in values_list:
            try:
                ...
                raise TypeError(f'"{value}" cannot be interpreted as a dict.')
        value = dictvalue
...
def _generate_list_validator(
    ...
    def _validate_list(value: str | list) -> list:
        ...
        if not isinstance(value, list):
            raise TypeError(f'"{value}" cannot be interpreted as a list.')
...
def _validate_bool(value: str | bool) -> bool:
    ...
    if isinstance(value, str):
        ...
        if value.lower().strip() in settings.truthy:
            ...
            raise TypeError(f'"{value}" cannot be interpreted as a boolean value.')

    if not isinstance(value, bool):
        raise TypeError(f'"{value}" is not a bool or a string.')
...
class BodhiConfig(dict):
    ...
    _defaults: ClassVar[dict[str, dict[str, Any]]] = {
        ...
        "updateinfo_rights": {
            "value": f"Copyright (C) {datetime.now(timezone.utc).year} Red Hat, Inc. and others.",
            "validator": str,
        },
    ...
    def load_config(self, settings: typing.Mapping | None = None):
        """
    ...
    def _validate(self):
        ...
        if errors:
            raise TypeError("Invalid config values were set: \n{}".format("\n".join(errors)))
