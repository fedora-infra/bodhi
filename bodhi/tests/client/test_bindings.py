...
class TestBodhiClient_get_critpath_packages(unittest.TestCase):
    """
    Test the BodhiClient.get_critpath_packages() method.
    """
...
class TestBodhiClient_add_critpath_packages(unittest.TestCase):
    """
    Test the BodhiClient.add_critpath_packages() method.
    """
    @mock.patch('bodhi.client.bindings.BodhiClient.critpath_package_request',
                return_value={'packages': [{'name': 'python'}, {'name': 'firefox'}]})
    def test_add_critpath_packages(self, request_method):
        ...
        resp = client.add_critpath_packages(release='F27', packages=['python', 'firefox'])

        self.assertEqual(resp, {'packages': [{'name': 'python'}, {'name': 'firefox'}]})
        request_method.assert_called_once_with(release='F27', verb='PUT', auth=True,
                                               data={'packages': 'python,firefox'})


class TestBodhiClient_remove_critpath_packages(unittest.TestCase):
    """
    Test the BodhiClient.remove_critpath_packages() method.
    """
    @mock.patch('bodhi.client.bindings.BodhiClient.critpath_package_request',
                return_value={'packages': []})
    def test_remove_critpath_packages(self, request_method):
        """Assert correct behavior from the remove_critpath_packages() method."""
        client = bindings.BodhiClient()

        resp = client.remove_critpath_packages(release='F27', packages=['python', 'firefox'])

        self.assertEqual(resp, {'packages': []})
        request_method.assert_called_once_with(release='F27', verb='DELETE', auth=True,
                                               data='{"packages": "python,firefox"}')


class TestBodhiClient_critpath_package_request(unittest.TestCase):
    """
    Test the BodhiClient.critpath_package_request() method.
    """
    @mock.patch('bodhi.client.bindings.BodhiClient.send_request',
                return_value={'packages': [{'name': 'python'}, {'name': 'firefox'}]})
    def test_critpath_package_request(self, send_request):
        ...
        client.send_request.assert_called_once_with(
            'releases/F27/critpath-packages', verb='GET', auth=True, data='some data')
    ...
    def test_critpath_package_request_invalid_verb(self, send_request):
        ...
        with self.assertRaises(bindings.BodhiClientException) as exc:
            client.critpath_package_request(release='F27', verb='POST', auth=True, data='blah')
