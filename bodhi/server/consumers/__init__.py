...
class Consumer:
    ...
    def __init__(self):
        ...
        self.handler_infos = [
            ...
            HandlerInfo('.bodhi.update.request.testing', 'Updates', updates_handler),
            HandlerInfo('.bodhi.update.edit', 'Updates', updates_handler),
        ]
        if ComposerHandler:
            self.handler_infos.append(
                HandlerInfo('.bodhi.composer.start', 'Composer', ComposerHandler()),
            )
        else:
