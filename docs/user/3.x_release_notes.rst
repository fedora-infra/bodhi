...
* A man page was written for ``bodhi-untag-branched`` (:commit:`2b83aeca`).
...
* A man page for ``bodhi-expire-overrides`` was written (:commit:`e4402a32`).
...
* ``bodhi-check-policies`` now also operates on pushed updates (:issue:`2085`).
